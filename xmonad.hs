...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    -- launch sublime text
    , ((modm .|. shiftMask, xK_s     ), spawn "subl")

    -- MOMENTARY: close eww
    , ((modm,               xK_o     ), spawn "/home/gianfra/eww/target/release/eww close powermenu")

    -- increase brightness
    , ((0, 0x1008ff02), spawn "lux -a 2%")

    -- decrease brightness
    , ((0, 0x1008ff03), spawn "lux -s 2%")
...
help = unlines ["The modifier key is WIN. Keybindings:",
    ...
    "mod-Shift-s      Launch Sublime Text",
